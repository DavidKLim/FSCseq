...
#' @param X optional input design matrix to specify p arbitrary covariates/confounders. Must be matrix of dimension n x p. If batch is additionally input, then X is augmented to incorporate batch as covariates.
